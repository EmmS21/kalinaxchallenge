...
import os
import numpy as np
path = 'https://raw.githubusercontent.com/EmmS21/kalinaxchallenge/master/finaldataset2.csv'
path_two = 'https://raw.githubusercontent.com/EmmS21/kalinaxchallenge/master/limitedsupervisor.csv'
#reading the data
